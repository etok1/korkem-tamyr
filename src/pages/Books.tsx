...
export default function Books(){
    return(
        ...
        <section className=" relative z-10 bg-whitishColor"  style={{  fontFamily: "Shantell Sans, cursive" }}>
            <div className="mt-10 ml-7 text-left lg:mt-14">
                <h1 className="text-lg xs:text-xl sm:text-3xl font-extrabold lg:text-5xl text-blueColor  ">
                📚 Наши бесплатные книги!
                </h1>
                <p className="text-blueColor pl-7 text-xs mt-0 xs:mt-1 xs:pl-8 sm:text-sm sm:pl-12 lg:pl-20 lg:text-base">Скачайте их по ссылкам ниже!👇</p>
            </div> 
            <svg xmlns="http://www.w3.org/2000/svg"  className="absolute top-[10%] xs:top-[8%] sm:top-[7%] md:top-[5%] lg:top-[6%] xl:top-[2%] 2xl:top-[-4%] z-0" viewBox="0 0 1440 320"><path fill="#8c93c7" fill-opacity="1" d="M0,128L48,122.7C96,117,192,107,288,117.3C384,128,480,160,576,165.3C672,171,768,149,864,128C960,107,1056,85,1152,69.3C1248,53,1344,43,1392,37.3L1440,32L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path></svg>
            <div className="flex flex-wrap items-center justify-center bg-dirtBlue h-full mt-32 pb-20 pt-10 gap-10 z-50">
                    ...
                    <div className="flex flex-wrap justify-center gap-6 md:gap-16 lg:gap-20 px-4 sm:px-0">
                        <div className="w-[280px] h-[470px]  rounded-2xl shadow-lg hover:shadow-xl overflow-hidden group transition-all duration-300 flex flex-col z-50">
                            ...
                            <div className="p-4 bg-[#FAFAF9] border-t border-gray-100">
                                <h3 className="text-dirtBlue font-bold text-lg mb-3">Қазақ Тарихы</h3>
                                <a
                                    href={kzBook}
                                    download="Kazakh_History_KZ.pdf"
                                    className="block w-full bg-dirtBlue hover:bg-blueColor  text-white text-center py-2 rounded-lg transition-colors duration-300 font-medium"
                                >
                                    📩 Скачать PDF
                                </a>
                            </div>
                        ...
                        <div className="w-[280px] h-[470px] rounded-2xl shadow-lg hover:shadow-xl overflow-hidden group transition-all duration-300 flex flex-col z-50">
                            ...
                            <div className="p-4 bg-[#FAFAF9] border-t border-gray-100">
                                <h3 className="text-dirtBlue  font-bold text-lg mb-3">Kazakh History</h3>
                                <a
                                    href={engBook}
